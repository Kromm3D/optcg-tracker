...
const ICON_PATHS: Record<string, string> = {
  ...
  // Fantasma Horo Horo: cuerpo ondulado + ojos como puntos (linecap redondo).
  ghost:   'M5 21v-9a7 7 0 0 1 14 0v9l-2.3-1.8-2.3 1.8-2.4-1.8-2.3 1.8L5 21ZM9.5 12h.01M14.5 12h.01',
};
